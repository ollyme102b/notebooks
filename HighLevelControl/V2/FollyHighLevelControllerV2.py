import numpy as np
from MPC_Alg.V2.CFTOCSolverV2 import CFTOCSolverV2
from Path_Planning.V2.circleLineIntersectionPath import circle_line_intersection_path
...
class FollyHighLevelControllerV2:
    ...
    def __init__(self, molly_initial_position,
        ...
        self.optimizer = CFTOCSolverV2(A, B, folly_initial_position, folly_desired_path, horizon, max_speed)
